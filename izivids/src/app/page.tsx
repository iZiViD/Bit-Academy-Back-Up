      ...
      {isClient && (
        <>
          <button onClick={askForScreenSharing} className="btn btn-circle btn-outline">
            <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 437.24">
          ...
          <video ref={videoRef} autoPlay style={{ width: "100%", height: "auto", marginTop: "20px" }} />
        </>
      )}
    </div>
  );
